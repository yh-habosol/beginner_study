...
plt.title("population movement", size = 30)
plt.xlabel("duratin", size = 20)
...
ax.set_xlabel("duration", color = 'blue')
...
ax2 = ax1.twinx()
ax2.plot(df.index, df.증감률, ls = '--', marker = 'o', markersize = 20, color ='red', label = "증감률")
